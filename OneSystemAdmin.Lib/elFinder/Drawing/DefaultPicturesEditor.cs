...
namespace OneSystemAdmin.Lib.elFinder.Drawing
{
    ...
    internal class DefaultPicturesEditor : IPicturesEditor
    {
        ...
        /// </summary>
        /// <param name="image">The <see cref="MediaTypeNames.Image"/> to rotate</param>
        /// <param name="degrees">The amount to rotate the image, clockwise, in degrees</param>
        /// <returns>A new <see cref="System.DrawingCore.Bitmap"/> that is just large enough to contain the rotated image without cutting any corners off.</returns>
